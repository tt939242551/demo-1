...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"vendor/marked.min.js":[function(require,module,exports) {
var define;
...
(function () {
    ...
    for (var r, s, i, l, o, h, a, p, c, e = e.replace(/^ +$/gm, ""); e;) {
      if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({
        ...
        for (e = e.substring(i[0].length), h = {
          ...
          /^ *-+: *$/.test(h.align[p]) ? h.align[p] = "right" : /^ *:-+: *$/.test(h.align[p]) ? h.align[p] = "center" : /^ *:-+ *$/.test(h.align[p]) ? h.align[p] = "left" : h.align[p] = null;
        }

        for (p = 0; p < h.cells.length; p++) {
          h.cells[p] = h.cells[p].split(/ *\| */);
        }
  ...
  c._inside = /(?:\[[^\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/, c._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, c.link = l(c.link)("inside", c._inside)("href", c._href)(), c.reflink = l(c.reflink)("inside", c._inside)(), c.normal = a({}, c), c.pedantic = a({}, c.normal, {
    ...
    for (var t, n, r, i, l = ""; e;) {
      if (i = this.rules.escape.exec(e)) e = e.substring(i[0].length), l += i[1];else if (i = this.rules.autolink.exec(e)) e = e.substring(i[0].length), "@" === i[2] ? (n = s(":" === i[1].charAt(6) ? this.mangle(i[1].substring(7)) : this.mangle(i[1])), r = this.mangle("mailto:") + n) : (n = s(i[1]), r = n), l += this.renderer.link(r, null, n);else if (this.inLink || !(i = this.rules.url.exec(e))) {
  ...
  h.exec = h, p.options = p.setOptions = function (e) {
    ...
    xhtml: !1,
    baseUrl: null
  }, p.Parser = r, p.parser = r.parse, p.Renderer = n, p.Lexer = e, p.lexer = e.lex, p.InlineLexer = t, p.inlineLexer = t.output, p.parse = p, "undefined" != typeof module && "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = p : "function" == typeof define && define.amd ? define(function () {
    return p;
  }) : this.marked = p;
}).call(function () {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","vendor/marked.min.js"], null)
//# sourceMappingURL=/marked.min.6efc0fd3.js.map